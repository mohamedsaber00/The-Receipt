package pro.thereceiptcompose.cache.model

import pro.thereceiptcompose.domain.model.Recipe
import pro.thereceiptcompose.domain.util.DomainMapper
import pro.thereceiptcompose.util.DateUtils
...
class RecipeEntityMapper : DomainMapper<RecipeEntity,Recipe>{
    ...
    override fun mapFromDomainModel(domainModel: Recipe): RecipeEntity {
        return RecipeEntity(
            ...
            dateRefreshed = DateUtils.dateToLong(DateUtils.createTimestamp())
        )
    }
